    ...
    <UDashboardPanel id="reception-interne" :ui-pro="{ body: 'p-0' }">
        ...
        <template #body>
            <UTable ref="table" v-model:column-filters="columnFilters" v-model:column-visibility="columnVisibility"
                ...
                :pagination-options="paginationOptions" class="shrink-0 m-2 bg-white dark:bg-(--ui-bg)"
                :data="organisations || []" :columns="columns" :loading="pending" :ui="{
...
const { data: organisations, pending, refresh: refreshOrganisations } = await useLazyAsyncData('organisations', async () => {
